...
const assetsLoader = {
    load (onProgress, onLoad) {
        ...
        PIXI.loader
            ...
            .add('./assets/characters/drake/drake_hit_0.png')
            .add('./assets/characters/drake/drake_hit_1.png')
            // ettercap
            ...
            .add('./assets/characters/ettercap/ettercap_hit_0.png')
            .add('./assets/characters/ettercap/ettercap_hit_1.png')
            // goblin
            ...
            .add('./assets/characters/goblin/goblin_hit_0.png')
            .add('./assets/characters/goblin/goblin_hit_1.png')
            // mage
            ...
            .add('./assets/characters/mage/mage_hit_0.png')
            .add('./assets/characters/mage/mage_hit_1.png')
            // player
            ...
            .add('./assets/characters/player/player_hit_0.png')
            .add('./assets/characters/player/player_hit_1.png')
            // skeleton
            ...
            .add('./assets/characters/skeleton/skeleton_hit_0.png')
            .add('./assets/characters/skeleton/skeleton_hit_1.png')
            // spider
            ...
            .add('./assets/characters/spider/spider_hit_0.png')
            .add('./assets/characters/spider/spider_hit_1.png')
            // tortoise
            ...
            .add('./assets/characters/tortoise/tortoise_hit_0.png')
            .add('./assets/characters/tortoise/tortoise_hit_1.png')
            // wasp
            ...
            .add('./assets/characters/wasp/wasp_hit_0.png')
            .add('./assets/characters/wasp/wasp_hit_1.png')
            // blob
            ...
            .add('./assets/characters/blob/blob_hit_0.png')
            .add('./assets/characters/blob/blob_hit_1.png')
